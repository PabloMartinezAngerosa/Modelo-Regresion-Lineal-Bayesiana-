...
con 16 variables cuantitativas agrupadas en las categorías climática, socioeconómica y de 
polución del aire. La Tabla 1 muestra la descripción de las variables en la 
base de datos.
...
```{r, fig.cap ="Gráfico de dispersión de HC contra NOX",fig.pos="H"}
plot(datos[,12:13])  
```
