...
para encontrar un modelo cuyos variables regresoras compuestas 
...
las default para los $\beta_{i}$ y el $\sigma^{2}$ presentes en el paquete de 
...
obtenemos que la posteriori conjugada es
...
centradas en los $\beta_{i}$ estimados por MCO con desviaciones típicas basadas en 
...
base::print(xtable::xtable(prev,
            caption = "Parámetros de las distribuciones normales previas para el modelo.",
            type="latex"),
            caption.placement = "bottom")
```
